        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/spring_security?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&autoReconnect=true",
                ...
                .globalConfig(builder -> {
                    ...
                    builder.author("dc")
                            ...
                            .fileOverride()
                            // 指定 Java 代码输出目录
                            .outputDir("D:/SpringSecurity/2-auth-database/src/main/java");
                })
                .packageConfig(builder -> {
                    // 设置父包名
                    builder.parent("top.dc")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:/Spring Security/2-auth-database/src/main/resources/mapper")); // 设置 mapperXml 生成路径
                })
